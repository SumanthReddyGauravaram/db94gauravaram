...
router.get('/', function (req, res) {
  res.render('index', { title: 'Mattress App', user : req.user });
  });

router.get('/register', function(req, res) {
  res.render('register', { title: 'Mattress App Registration'});
});
...
router.get('/login', function(req, res) {
  res.render('login', { title: 'Mattress App Login', user : req.user });
});
